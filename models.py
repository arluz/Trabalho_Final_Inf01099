...
class Alunos(db.Model):
    ...
    id_aluno = db.Column(db.Integer, autoincrement=True, primary_key=True)
...
class Turmas(db.Model):
    ...
    id_turma = db.Column(db.Integer, autoincrement=True, primary_key=True)
...
class AlunosTurmas(db.Model):
    ...
    id_aluno_turma = db.Column(db.Integer, autoincrement=True, primary_key=True)
...
class Conteudos(db.Model):
    ...
    id_conteudo = db.Column(db.Integer, autoincrement=True, primary_key=True)
    id_disciplina = db.Column(db.Integer, db.ForeignKey("disciplinas.id_disciplina"), nullable=False)
...
class Habilidades(db.Model):
    ...
    id_habilidade = db.Column(db.Integer, autoincrement=True, primary_key=True)
    id_disciplina = db.Column(db.Integer, db.ForeignKey("disciplinas.id_disciplina"), nullable=False)
    codigo = db.Column(db.String(20), nullable=False)
    nivel = db.Column(db.String(50), nullable=False)
